			...
			<div id="wrapper">
				...
				<!-- Intro -->
					<section class="intro">
						<header>
							<h1>개발하는 차영빈</h1>
							<p><h3>포토폴리오<br><br>↓프로젝트(업데이트중..)↓</h3> 
				...
				<!-- Section -->
					<section>
						...
						<div class="content">
							<p><strong>#차영빈</strong> &nbsp;  <strong>#취미생활</strong></p>
							<ul class="feature-icons">
								<li class="icon solid fa-laptop-code">Coding</li>
								<li class="icon solid fa-dumbbell">Work out</li>
								<li class="icon solid fa-bicycle">Bicycle</li>
								<li class="icon solid fa-gamepad">Game</li>
					...
					<section>
						...
						<footer>
							<ul class="items">
								<li>
									<h3>Email</h3>
									<a href="#">chyb627@naver.com</a>
								</li>
								<li>
									<h3>Phone</h3>
									<a href="#">010-2700-5745</a>
								</li>
								<!--<li>
									<h3>Address</h3>
									<span>서울시 강남구 양재대로 55길 </span>
								</li>-->
								<li>
									<h3>Elsewhere</h3>
									<ul class="icons">
										<!-- <li><a href="#" class="icon brands fa-twitter"><span class="label">Twitter</span></a></li>
										<li><a href="#" class="icon brands fa-facebook-f"><span class="label">Facebook</span></a></li> -->
										<li><a href="https://www.instagram.com/chabiri" class="icon brands fa-instagram"><span class="label">Instagram</span></a></li>
